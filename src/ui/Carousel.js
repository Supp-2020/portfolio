...
export default function ImageCarousel({ images }) {
  ...
  return (
    <div className="w-full overflow-hidden animate-in fade-in zoom-in-95">
      {/* Carousel with Peek Effect */}
      <div className="relative h-96 overflow-hidden perspective rounded-lg">
        ...
        <button
          ...
          className="absolute left-4 top-1/2 z-20 -translate-y-1/2 rounded-full bg-white/90 p-2 hover:bg-white cursor-pointer transition-all hover:scale-110 shadow-lg"
        ...
        <button
          onClick={goToNext}
          className="absolute right-4 top-1/2 z-20 -translate-y-1/2 rounded-full bg-white/90 p-2 hover:bg-white cursor-pointer transition-all hover:scale-110 shadow-lg"
